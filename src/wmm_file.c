 ...
 *  Revision Number: $Revision: 1522 $
 *  Last changed by: $Author: awoods $
 *  Last changed on: $Date: 2017-01-24 11:02:11 -0700 (Tue, 24 Jan 2017) $
...
/*        printf("\nWelcome to the World Magnetic Model (WMM) C-Program\nof the US National Geophysical Data Center\n               --- File Processing Program ----\n             --- Model Release Date: 15 Dec %d ---\n           --- Software Release Date: %s ---\nUSAGE:\n", (int)MagneticModels[0]->epoch - 1, VersionDate);
        This line is temporarily removed for the WMM2015v2 release
        */
        do {
            printf("\nWelcome to the World Magnetic Model (WMM) C-Program\nof the US National Geophysical Data Center\n");
            ...
            printf("USAGE:\n");
            printf("For example: WMM_file f input_file output_file\n");
            printf("This screen: WMM_file h \n");
            printf("\n");
